...
namespace GLib {
	...
	namespace FileAttribute {
		...
		[CCode (cheader_filename = "gio/gio.h", cname = "G_FILE_ATTRIBUTE_UNIX_UIManagerD")]
		public const string UNIX_UIManagerD;
	}
	namespace VolumeIdentifier {
		...
		public const string UNIX_DEVICE;
		[CCode (cheader_filename = "gio/gio.h", cname = "G_VOLUME_IDENTIFIER_KIND_UUIManagerD")]
		public const string UUIManagerD;
	}
	...
	public interface File : GLib.Object {
		...
		public bool load_contents (GLib.Cancellable? cancellable, [CCode (array_length_cname = "length", array_length_pos = 2.5, array_length_type = "gsize")] out char[] contents, out string etag_out) throws GLib.Error;
	...
	[CCode (cheader_filename = "gio/gio.h")]
	[Deprecated (replacement = "FileAttribute.UNIX_UIManagerD", since = "vala-0.16")]
	public const string FILE_ATTRIBUTE_UNIX_UIManagerD;
	[CCode (cheader_filename = "gio/gio.h")]
	...
	[CCode (cheader_filename = "gio/gio.h")]
	[Deprecated (replacement = "GLib.VolumeIdentifier.UUIManagerD", since = "vala-0.16")]
	public const string VOLUME_IDENTIFIER_KIND_UUIManagerD;
	[CCode (cheader_filename = "gio/gio.h")]
