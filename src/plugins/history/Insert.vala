...
public class Insert : Action, GLib.Object
{
	...
	public void undo ()
	{
		...
		if (range == text)
			...
			stdout.puts (@"Attempting to undo insert with invalid state. '$range' '$text'\n");
	}

	public Action reverse ()
	{
		return new Delete (buffer, start, end, text);
	}
	...
	{
		return @"<span color=\"gray\">$line_str</span> <span color=\"green\" weight=\"bold\">+</span> $(text.escape (""))";
	}
}
